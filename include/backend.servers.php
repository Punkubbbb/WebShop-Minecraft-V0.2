...
if($Config["bungeecord"]["status"]=="on"){
        ...
        echo '
             ...
             <div class="card">
<div class="card-header slash bg-success" style="color: white;"><i class="fa fa-plus-square"></i>&nbsp;เพิ่มเซิร์ฟเวอร์
...
<div class="card-header slash bg-success" style="color: white;"><i class="fa fa-pencil"></i>&nbsp;แก้ไขเซิร์ฟเวอร์
</div><div class="card-body">
...
echo '
<div class="card">
<div class="card-header slash bg-danger" style="color: white;"><i class="fa fa-pencil"></i>&nbsp;จัดการเซิร์ฟเวอร์
</div><div class="card-body">
